...
export interface DiscoursePublicUserItem extends S.Infer<typeof DiscoursePublicUserItem> {}

export const decodePublicUserItem = (user:unknown) => P.decode<DiscoursePublicUserItem>(DiscoursePublicUserItem)(user, {isUnexpectedAllowed:true})
...
export interface DiscoursePublicUser extends S.Infer<typeof DiscoursePublicUser> {}

export const decodePublicUser = (user:unknown) => P.decode<DiscoursePublicUser>(DiscoursePublicUser)(user, {isUnexpectedAllowed:true})
...
export interface DiscoursePrivateUser extends S.Infer<typeof DiscoursePrivateUser> {}
...
export const extractCategoriesFrom = (response:ListCategoriesResponseContent) => pipe(

...
export interface OperationSuccessResponse extends S.Infer<typeof OperationSuccessResponse> {}

export const decodeOperationSuccessResponse = P.decode<OperationSuccessResponse>(OperationSuccessResponse)
...
export const decodeDiscoursePost = (i:unknown) => decodeDiscoursePostStrict(i, { isUnexpectedAllowed: true })

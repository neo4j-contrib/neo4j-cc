import { Effect, Layer, Context, pipe, Option, Duration, Chunk } from "@neo4j-cc/prelude"
...
export interface KhorosService {
  readonly query: <RequestResult>(args: {q?: string; }) => Effect.Effect<never, FetchError, RequestResult>
  readonly getMessageById: (messageId: string) => Effect.Effect<never, FetchError | KhorosError, KhorosMessage>
  readonly getLatestMessages: () => Effect.Effect<never, FetchError | KhorosError, Chunk.Chunk<Item>>
  readonly getMessagesOnDate: (args:GetMessagesOnDateArgs) => Effect.Effect<never, FetchError, Chunk.Chunk<Item>>
  readonly getAllMessagesOnDate: ({ day }: {day: Date;}) => Effect.Effect<never, FetchError, Chunk.Chunk<Item>>
  readonly getMessagesWithCursor: (args:GetMessagesWithCursor) => Effect.Effect<never, FetchError, {items:Item[], cursor: string | undefined}>
  readonly getAllMessages: <A>(pager: (page: Item[]) => Effect.Effect<never, never, A>) => Effect.Effect<never, FetchError, Chunk.Chunk<A>>

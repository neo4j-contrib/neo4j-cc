...
export type GraphNodeFieldsFragment = {
  __typename?: 'GraphNode';
  _id?: number | null;
...
export type CreateGraphNodeMutation = {
  __typename?: 'Mutation';
  createGraphNodes: {
    __typename?: 'CreateGraphNodesMutationResponse';
    graphNodes: Array<{
...
`;
export type CreateGraphNodeMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateGraphNodeMutation(
  ...
  return Apollo.useMutation<
    CreateGraphNodeMutation,
    CreateGraphNodeMutationVariables
  >(CreateGraphNodeDocument, options);
}
export type CreateGraphNodeMutationHookResult = ReturnType<
  typeof useCreateGraphNodeMutation
>;
export type CreateGraphNodeMutationResult =
  Apollo.MutationResult<CreateGraphNodeMutation>;
export type CreateGraphNodeMutationOptions = Apollo.BaseMutationOptions<
  CreateGraphNodeMutation,
  CreateGraphNodeMutationVariables
>;
 ...
 * });
 */
export function useGetGraphNodeQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetGraphNodeQuery, GetGraphNodeQueryVariables>(
    GetGraphNodeDocument,
    options
  );
}
export function useGetGraphNodeLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetGraphNodeQuery, GetGraphNodeQueryVariables>(
    GetGraphNodeDocument,
    options
  );
}
export type GetGraphNodeQueryHookResult = ReturnType<
  typeof useGetGraphNodeQuery
>;
export type GetGraphNodeLazyQueryHookResult = ReturnType<
  typeof useGetGraphNodeLazyQuery
>;
export type GetGraphNodeQueryResult = Apollo.QueryResult<
  GetGraphNodeQuery,
  GetGraphNodeQueryVariables
>;

...
describe('FileSystemService', () => {
  const runWithFileSystem = (
    program: Effect.Effect<FileSystemService, FileSystemError, ExistsResult>
  ) =>
    pipe(
  ...
  it('write', async () => {
    ...
    const content =
      "tap, tap, tap... that's a peek into an effect, three times";

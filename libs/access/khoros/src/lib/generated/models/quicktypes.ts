...
export class Convert {
  ...
  public static queryASingleCollectionToJson(
    value: QueryASingleCollection
  ): string {
  ...
  public static getMessageAttachmentToJson(
    value: GetMessageAttachment
  ): string {
  ...
  public static toGetProductAssociatedWithMessage(
    json: string
  ): GetProductAssociatedWithMessage {
    return cast(JSON.parse(json), r('GetProductAssociatedWithMessage'));
  }

  public static getProductAssociatedWithMessageToJson(
    value: GetProductAssociatedWithMessage
  ): string {
    return JSON.stringify(
      uncast(value, r('GetProductAssociatedWithMessage')),
      null,
      2
    );
  }
...
const typeMap: any = {
  ...
  Item: o(
    [
      ...
      { json: 'board', js: 'board', typ: u(undefined, r('Author')) },
      {
        json: 'conversation',
        js: 'conversation',
        typ: u(undefined, r('Conversation')),
      },
      ...
      {
        json: 'post_time_friendly',
        js: 'post_time_friendly',
        typ: u(undefined, ''),
      },
      ...
      {
        json: 'can_accept_solution',
        js: 'can_accept_solution',
      ...
      },
      {
        ...
        js: 'moderation_status',
        typ: u(undefined, r('ModerationStatus')),
      },
      {
        json: 'user_context',
        js: 'user_context',
        typ: u(undefined, r('ItemUserContext')),
      },
      { json: 'device_id', js: 'device_id', typ: u(undefined, r('DeviceID')) },
      { json: 'popularity', js: 'popularity', typ: u(undefined, 3.14) },
      {
        json: 'excluded_from_kudos_leaderboards',
        js: 'excluded_from_kudos_leaderboards',
        typ: u(undefined, true),
      },
      ...
      {
        json: 'helpfulness_allowed',
        js: 'helpfulness_allowed',
        typ: u(undefined, true),
      },
      { json: 'latest_version', js: 'latest_version', typ: u(undefined, '') },
      {
        json: 'content_workflow',
        js: 'content_workflow',
        typ: u(undefined, r('ContentWorkflow')),
      },
      ...
      {
        json: 'upload_time_friendly',
        js: 'upload_time_friendly',
        typ: u(undefined, ''),
      },
  ...
  Attachments: o([{ json: 'query', js: 'query', typ: '' }], false),
  Author: o(
    [
  ...
  ContentWorkflow: o(
    [
      ...
      {
        json: 'message_draft_history',
        js: 'message_draft_history',
        typ: r('Attachments'),
      },
      {
        json: 'user_context',
        js: 'user_context',
        typ: r('ContentWorkflowUserContext'),
      },
      { json: 'view_href', js: 'view_href', typ: '' },
    ],
    false
  ...
  Conversation: o(
    [
      ...
      {
        json: 'last_post_time_friendly',
        js: 'last_post_time_friendly',
        typ: '',
      },
    ],
    false
  ...
  GetProductAssociatedWithMessage: o(
    [
      ...
      { json: 'http_code', js: 'http_code', typ: 0 },
      {
        json: 'data',
        js: 'data',
        typ: r('GetProductAssociatedWithMessageData'),
      },
      { json: 'metadata', js: 'metadata', typ: r('MetadataClass') },
    ],
    false
  ...
  AuthorType: ['board', 'message', 'user'],
  Style: ['forum', 'tkb'],
  ConversationType: ['conversation'],
  CurrentRevisionType: ['revision'],
  DeviceID: ['firefox_102_0', 'google_chrome_101', 'google_chrome_99'],
  Language: ['EN'],
  MetricsType: ['message_metrics'],
  ModerationStatus: ['approved'],
  UserContextType: ['user_context'],
};

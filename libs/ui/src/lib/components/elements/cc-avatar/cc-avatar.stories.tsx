...
import { CcAvatar, CcAvatarProps } from './cc-avatar'

export default {
  component: CcAvatar,
  title: 'elements/CcAvatar',
  argTypes: {
    size: {
...
export const Daisy: Story<AvatarProps> = (args) => {
  return <Avatar {...args} />
}
...
const Template: Story<CcAvatarProps> = (args) => {
  return <CcAvatar {...args} />
}
...
export const Group: Story<CcAvatarProps> = (args) => {
  return (
    <CcAvatar.Group>
      <CcAvatar {...args} />
      <CcAvatar {...args} />
...
export const MultipleChildren: Story<Omit<CcAvatarProps, 'children'>> = (
  args
) => {
  return (
    <CcAvatar {...args}>

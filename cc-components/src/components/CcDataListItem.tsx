...
import { selectMachine } from './machines';


export interface CcDataListItemProps {
...
/**
 * An individual list item designed to work inside a CcDataList
 * 
 * Hoverable, selectable, actionable.
 */
export const CcDataListItem: React.FC<CcDataListItemProps> = ({
  value: record,
  onSelect
}) => {

...
import { Identifier, SemanticVersionString, UrlString } from "../value";
import { IsoDate } from "../value/datetime.model";

// import * as Parser from "@effect-ts/schema/Parser";

export class CreativeWork extends Model<CreativeWork>()(
  pipe(
    S.struct({
      required:{},
      optional: {
        /** The subject matter of the content. */
        "about": S.array(UrlString), // SchemaValue<Thing | IdReference>;
        /** An abstract is a short description that summarizes a {@link https://schema.org/CreativeWork CreativeWork}. */
        "abstract": S.string, // SchemaValue<Text>;
        ...
        "creator": Identifier, // SchemaValue<Organization | Person | IdReference>;
        /** Text that can be used to credit person(s) and/or organization(s) associated with a published Creative Work. */
        // "creditText"?: SchemaValue<Text>;
        /** The date on which the CreativeWork was created or the item was added to a DataFeed. */
        "dateCreated": IsoDate, // SchemaValue<Date | DateTime>;
        /** The date on which the CreativeWork was most recently modified or when the item's entry was modified within a DataFeed. */
        "dateModified": IsoDate, // SchemaValue<Date | DateTime>;
        /** Date of first broadcast/publication. */
        "datePublished": IsoDate, // SchemaValue<Date | DateTime>;
        /** A link to the page containing the comments of the CreativeWork. */
        "discussionUrl": UrlString, // SchemaValue<URL>;
        /**
        ...
        "keywords": S.array(S.string), // SchemaValue<DefinedTerm | Text | URL | IdReference>;
        /** The predominant type or kind characterizing the learning resource. For example, 'presentation', 'handout'. */
        // "learningResourceType"?: SchemaValue<DefinedTerm | Text | IdReference>;
        /** A license document that applies to this content, typically indicated by URL. */
        "license": UrlString, // SchemaValue<CreativeWork | URL | IdReference>;
        ...
        "publisher": Identifier, // SchemaValue<Organization | Person | IdReference>;
        ...
        // "schemaVersion": SemanticVersionString, // SchemaValue<Text | URL>;
        ...
        "version": SemanticVersionString, // SchemaValue<Number | Text>;
